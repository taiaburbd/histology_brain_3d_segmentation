...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot',default = r'./mouse_brain_seg', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')#required = True 
        ...
        parser.add_argument('--ngf', type=int, default=64, help='# of gen filters in the last conv layer')##################################64减小为32
        parser.add_argument('--ndf', type=int, default=64, help='# of discrim filters in the first conv layer')################################64
        ...
        parser.add_argument('--batch_size', type=int, default=9, help='input batch size')#########################################################!!!
        ...
        # wandb parameters
        parser.add_argument('--use_wandb', default = True , help='if specified, then init wandb logging')########################action='store_true'
        parser.add_argument('--wandb_project_name', type=str, default='pix2pix_seg', help='specify wandb project name')
