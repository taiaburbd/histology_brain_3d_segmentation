...
nnUNetv2_predict -d 1 -i /user1/ngmm/tr855969/Desktop/Taiabur/ngmm-nnunet/dataset/nnUNet_test_data -o /user1/ngmm/tr855969/Desktop/Taiabur/ngmm-nnunet/dataset/nnUNet_Prediction_Results/Dataset001_Wdr47Kusss/3d_fullres -f  0 1 2 3 4 -tr nnUNetTrainer -c 3d_fullres -p nnUNetPlans
# Get the current date and time in a specific format (e.g., YYYY-MM-DD_HH-MM-SS) and store it in a variable.
CURRENT_DATETIME=$(date "+%Y-%m-%d_%H-%M-%S")

# Run the Python version command and redirect its output to a file named versions_YYYY-MM-DD_HH-MM-SS.txt.
# Then, append the Conda version information to the same file.
...
echo "Ending the shell script_second"
